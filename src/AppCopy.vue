    ...
    section.section(v-show="!isLoading")
      nav.nav
        .container
          .field.has-addons
            .control.is-expanded
              input.input.is-large(type="text", placeholder="What song you are looking for?", v-model="searchQuery")
            .control
      ...
      .container.results
        .columns.is-multiline
          .column.is-one-quarter(v-for="(t in tracks")
            DL-track(v-bind:track="t" @select="setSelectedTrack" :class="{'is-active': t.id === selectedTrack }")
...
import DLFooter from '@/components/layouts/Footer.vue'
import DLHeader from '@/components/layouts/Header.vue'
...
export default {
  name: 'app',
  components: { DLFooter, DLHeader, DLTrack, DLLoader, DLNotification },
  data () {
    return {
